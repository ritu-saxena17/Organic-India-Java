 ...
 */
public class BakeryController implements Initializable 
{
     ...
     *
     * @param event
     * @throws FXMLMenuController.IOException
     */
    static float bill=0;
    ...
    {  
        try
        {
            ...
            pw.println("           Bread                            "+value1+"                                "+(value1*40));
            bill+=value1*40;
            pw.flush();
            pw.close();
            }
    ...
    {  
        try
        {
            ...
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            pw.println("          Cookies                        "+value2+"                                "+(value2*10));
            bill+=value2*10;
            pw.flush();
            pw.close();
            }
    ...
    {  
        ...
        {   
            ...
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            pw.println("          Muffins                        "+value3+"                                "+(value3*20));               
            bill+=value3*20;
            pw.flush();
            pw.close();
            }
    ...
    {  
        try
        {
            ...
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            pw.println("          Samosa                        "+value4+"                                "+(value4*20));      
            bill+=value4*20;
