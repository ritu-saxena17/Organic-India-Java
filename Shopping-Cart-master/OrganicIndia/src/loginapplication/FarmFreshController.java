 ...
 */
public class FarmFreshController implements Initializable
{
    ...
    {  
        try
        {
            ...
            pw.println("          Apple                          "+value1+"                                "+(value1*60));
            bill+=value1*40;
            pw.flush();
            pw.close();
            }
    ...
    {  
        try
        {
            ...
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            pw.println("          Tomato                       "+value2+"                                "+(value2*20));
            bill+=value2*10;
            pw.flush();
            pw.close();
            }
    ...
    {  
        ...
        {   
            ...
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            pw.println("          Banana                       "+value3+"                                "+(value3*60));
            bill+=value3*20;
            pw.flush();
            pw.close();
            }
    ...
    {  
        try
        {
            ...
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            pw.println("          Carrot                        "+value4+"                                "+(value4*40));
            bill+=value4*20;
